...
from funciones_bodega import obtener_oc , recepcionar_oc , rechazar_oc , stock , cantidad_producto , cocinar_prod_sku
from time import *
...
def verficar():
	...
	for orden in lista_id:
		if orden[2] <= cantidad_producto(orden[1]):
			...
			lista_id.pop(index)
			#despacho_productos dado la orden despachar_producto(orden[0])
		else:
			pass
